        ...
        <>
            <nav className="z-20 bg-beige-100 flex items-center py-4 shadow-lg sticky top-0 w-screen">
                ...
                <div className="nav-links flex justify-center flex-col sm:flex-row">
                    <a href="/" className="rounded-lg px-5 py-2 text-black mx-3 hover:bg-beige-400 hover:shadow-md transition duration-500 font-mono">Home</a>
                    ...
                    <a href="/" className="rounded-lg px-5 py-2 text-black mx-3 hover:bg-beige-400 hover:shadow-md transition duration-500 font-mono">Contact</a>
                </div>
